    ...
    return (
        ...
        <div className="flex flex-col gap-6 h-full">
          <div className="flex flex-col gap-3">
            <div className="flex iemns-center justify-between">
              <DialogTitle>
                  Cadastrar metas
              </DialogTitle>
              <DialogClose>
          ...
          <form onSubmit={handleSubmit(handleCreateGoal)} className="flex-1 flex flex-col justify-between">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input id="title" autoFocus placeholder="Praticar exercicios, meditar, etc" {...register('title')} ></Input>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Controller control={control} name="desiredWeeklyFrequency" render={({field})=> {
                  return (
